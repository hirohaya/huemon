            ...
            if child.tag == "attacks":
                ...
                while skill < 5:
                    if skill == 0:
                        ...
                        xml_file.write("      <power_points>"+str(pokemon1.move0.remaining_pp)+"</power_points>\n")
                    if skill == 1:
                        ...
                        xml_file.write("      <power_points>"+str(pokemon1.move1.remaining_pp)+"</power_points>\n")
                    if skill == 2:
                        ...
                        xml_file.write("      <power_points>"+str(pokemon1.move2.remaining_pp)+"</power_points>\n")
                    if skill == 3:
                        ...
                        xml_file.write("      <power_points>"+str(pokemon1.move3.remaining_pp)+"</power_points>\n")
                    if skill == 4:
                        ...
                        xml_file.write("      <power_points>"+str(pokemon1.move4.remaining_pp)+"</power_points>\n")
                    skill = skill + 1
                ...
                if child.tag == "attacks":
                    ...
                    while skill < 5:
                        if skill == 0:
                            ...
                            xml_file.write("      <power_points>"+str(pokemon2.move0.remaining_pp)+"</power_points>\n")
                        if skill == 1:
                            xml_file.write("      <id>1</id>\n")
                            ...
                            xml_file.write("      <power_points>"+str(pokemon2.move1.remaining_pp)+"</power_points>\n")
                        if skill == 2:
                            xml_file.write("      <id>2</id>\n")
                            ...
                            xml_file.write("      <power_points>"+str(pokemon2.move2.remaining_pp)+"</power_points>\n")
                        if skill == 3:
                            xml_file.write("      <id>3</id>\n")
                            ...
                            xml_file.write("      <power_points>"+str(pokemon2.move3.remaining_pp)+"</power_points>\n")
                        if skill == 4:
                            xml_file.write("      <id>4</id>\n")
                            ...
                            xml_file.write("      <power_points>"+str(pokemon2.move4.remaining_pp)+"</power_points>\n")
                        skill = skill + 1
                if child.tag == "power_points":
                    xml_file.write("    </attacks>\n")
                    xml_file.write("  </pokemon>\n")
